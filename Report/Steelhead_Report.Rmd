...
Steelhead are not targeted by Canadian commercial fisheries but are bycatch in some salmon-targeted fisheries, including Area B seine, Area D gillnet, Area E gillnet, Area G gillnet, and Area H troll (collectively referred to hereafter as Canadian commercial fisheries (CCF)). Steelhead may also be bycatch in First Nation salmon-targeted fisheries, particularly in Economic Opportunity (EO) fisheries targeting late-run Fraser sockeye, Fraser pink and Southern Chum. These were divided into Below Port Mann drift net (BPM DN), Above Port Mann gillnet (APM GN), and Above Port Mann beach seine (APM BSn), and are collectively referred to hereafter as Canadian First Nation fisheries (CFNF).  
...
We also calculated iterative exposure to fisheries by assuming an approximate progression of encounters to each fishery. 
...
The graphs of iterative exposure show how much more of the population is exposed due to each fishery following the previous fisheries. 
For example, in the first figure for 2004 the Area G fishery exposes 0% of the population to fishing activity. 
Moving right along the x-axis, the next fishery encountered by the population is Area B. 
In this year, Area B fisheries expose around 63% of the population to fishing activity. 
Moving right again, the Area D fishery exposes an additional 18% of the population to fishing activity, which was not exposed to either Area G or Area B fisheries.  
...
The reconstructions of simulated steelhead population exposure to actual fisheries that occurred each year suggest that some fisheries (Area H, Area B, Area D) have a much lower likelihood of meeting the goal of exposing less than 20% of the population to fishing activity than others (Area G, Area E). 
...
2. Calculate actual probabilities of exposing <20% of the population to each fishery;
